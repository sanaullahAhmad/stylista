...
<div id="items">
    ...
    <?php
	$catee = $_GET['s'];
	$cat_qur = "select * from tbl_category where pk_cat_id = $catee";
	$cat_sql = mysql_query($cat_qur);
	$cat_res = mysql_fetch_array($cat_sql);
	echo "<h1>".$cat_res['category_name']."</h1><br>";
$qqq = "select * from tbl_product where fk_cat_id = $catee";
$qrr = mysql_query($qqq);
$nnn = 1;
