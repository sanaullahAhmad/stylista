...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <?php if ($_REQUEST['page'] == 'products') {
            ?>
            <link type="text/css" href="<?php echo $ru ?>css/product.css" media="screen" rel="stylesheet" />
        <?php } else {
            ?>
            <link type="text/css" href="<?php echo $ru ?>css/style.css" media="screen" rel="stylesheet" />
        <?php } ?>
    <link type="text/css" href="<?php echo $ru ?>css/reveal_deals.css" media="screen" rel="stylesheet" />
    <link type="text/css" href="<?php echo $ru ?>css/style_navigation.css" rel="stylesheet" />
    <script>
