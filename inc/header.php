...
<div id="links">
    ...
    <a href="<?php echo $ru ?>shops#products-bar"><img src="<?php echo $ru ?>images/shops.png" /></a>
    <a href="<?php echo $ru ?>products#products-bar"><img src="<?php echo $ru ?>images/products.png" /></a>
    <a href="<?php echo $ru ?>deals#products-bar"><img src="<?php echo $ru ?>images/deals.png" /></a>
...
<div id="login" class="reveal-modal">
    ...
    <table class="table">
        <form name="user_signup" action="<?php echo $ru ?>process/process_login.php" method="post" id="signup_form" class="well span5" enctype="multipart/form-data">
            <tr>
                
                <td style="border:none;" class="text-form" width="100" align="left">User name:</td>
                <td style="border:none;" align="left"><input  type="text" class="input" name="shop_name" required="required"/></td>
            </tr>
            <tr>
                <td style="border:none;" width="100" class="text-form" align="left">Password:</td>
                <td style="border:none;" align="left"><input class="input" type="password" name="user_password" required="reqiuired"/></td>
...
jQuery(document).ready(function(){
 var src = 100;
  ...
  var scrol = src - 200;
  jQuery('html, body, .content').animate({scrollTop: scrol}, 1000);
  src = src -200
  return false;
  });
  ...
  jQuery('#right1').click(function(){
  var scrol = src + 200;
  jQuery('html, body, .content').animate({scrollLeft: scrol}, 1000);
  src = src +200
  return false;
  });
  
  jQuery('#left1').click(function(){
  var scrol = src - 200;
  jQuery('html, body, .content').animate({scrollLeft: scrol}, 1000);
  src = src -200
  return false;
...
<div id="navigation1">
    	<div id="top1">
        	<img src="<?php echo $ru ?>images/top1.png" />
        </div>
    	<div id="left1">
        	<img src="<?php echo $ru ?>images/left1.png" />
        </div>
    	<div id="right1">
        	<img src="<?php echo $ru ?>images/right1.png" />
        </div>
    	<div id="bottom1">
        	<img src="<?php echo $ru ?>images/bottom1.png" />
        </div>
    </div>