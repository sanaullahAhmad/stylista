...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		...
		<title>.::&nbsp;Press Council of Pakistan&nbsp;|&nbsp;Admin&nbsp;::.</title>
...
<body id="login">
		...
		<div id="login-wrapper" class="png_bg">
			<div id="login-top">
				...
				<h1>Press Council of Pakistan</h1>
				<!-- Logo (221px width) -->
				<img id="logo" src="proj_resources/images/logo.png" alt="Airline Connect" />
			...
			<div id="login-content">
                ...
                <?php } else { ?>
					<div class="notification information png_bg">
						...
						<div>
							Enter Username and Password for Login to admin section
						</div>
					</div>
				<?php } ?>	
					<p>
